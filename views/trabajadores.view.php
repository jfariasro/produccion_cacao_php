                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th>Dirección</th>
                                    <th>Acciones
                                        <a data-toggle="modal" data-target="#AddModal" href="javascript:void(0);" title="Aregar Nuevo Trabajador"><i class="fa fa-plus" aria-hidden="true"></i></a>
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <a data-toggle="modal" title="Modificar Trabajador" data-target="#EditModal" href="javascript:void(0);" onclick="document.getElementById('id').value = <?= $row['id'] ?>;document.getElementById('nombre').value = '<?= $row['nombre'] ?>';document.getElementById('email').value = '<?= $row['email'] ?>';document.getElementById('direccion').value = '<?= $row['direccion'] ?>';" style="margin-right: 5px;"> <i class="fas fa-edit"></i> </a>
                                                </div>
                                                <div class="col-sm-6">
                                                    <a data-toggle="modal" title="Eliminar Trabajador" data-target="#DeleteModal" href="javascript:void(0);" onclick="document.getElementById('delete_id').value = <?= $row['id'] ?>;document.getElementById('delete_nombre').innerHTML = '<?= $row['nombre'] ?>';" class="text-danger borrar"> <i class="fas fa-trash"></i> </a>
                                                </div>
                                            </div>
            ...
            <div class="modal-body">
                <form action="panel.php?modulo=trabajadores" id="ingresar" method="POST">
                    <div class="form-group">
                        <label>Nombre</label>
                        <input type="text" name="add_nombre" id="add_nombre" class="form-control" placeholder="Nombres del Trabajador" required>
                    </div>
                    <div class="form-group">
                        <label>Email</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="panel.php?modulo=trabajadores" method="POST">
                    ...
                    <input type="submit" name="modificar_trabajador" id="modificar_trabajador" Value="Actualizar" class="btn btn-primary">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="panel.php?modulo=trabajadores" method="POST">
                    ...
                    <input type="submit" name="eliminar_trabajador" id="eliminar_trabajador" Value="Eliminar" class="btn btn-primary">
