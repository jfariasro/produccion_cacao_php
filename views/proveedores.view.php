                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th>Dirección</th>
                                    <th>Acciones
                                        <a data-toggle="modal" data-target="#AddModal" href="javascript:void(0);" title="Aregar Nuevo Proveedor"><i class="fa fa-plus" aria-hidden="true"></i></a>
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
            ...
            <div class="modal-body">
                <form action="panel.php?modulo=proveedores" id="ingresar" method="POST">
                    <div class="form-group">
                        <label>Nombre</label>
                        <input type="text" name="add_nombre" id="add_nombre" class="form-control" placeholder="Nombres del Proveedor" required>
                    </div>
                    <div class="form-group">
                        <label>Email</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="panel.php?modulo=proveedores" method="POST">
                    ...
                    <input type="submit" name="modificar_proveedor" id="modificar_proveedor" Value="Actualizar" class="btn btn-primary">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="panel.php?modulo=proveedores" method="POST">
                    ...
                    <input type="submit" name="eliminar_proveedor" id="eliminar_proveedor" Value="Eliminar" class="btn btn-primary">
